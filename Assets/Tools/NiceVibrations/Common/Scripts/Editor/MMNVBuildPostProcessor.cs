...
namespace MoreMountains.NiceVibrations
{
    ...
    public class MMNVBuildPostProcessor : IPostprocessBuildWithReport
    {
        ...
        public static void DeterminePaths()
        {
            ...
            {
                Debug.LogError(
                    "[MMNVBuildPostProcessor] No MMNVPath asset could be found. Make sure you have one named MMNVPathDefinition in a Resources folder.");
            }
        }
        ...
        private static void WritePropertiesToFramework(PBXProject pbxProject, string targetGUID, string pbxProjectPath,
            string pluginPath, bool forceAlwaysEmbedSwiftStandardLibraries)
        {
            ...
            Debug.Log("[MMNVBuildPostProcessor] Add module reference : " + _moduleFileUnityPath + " -> " +
            ...
            Debug.Log("[MMNVBuildPostProcessor] Copy module file to project : " + moduleFilePath + " -> " +
                      destination);
        ...
        /// </summary>
        private static void WritePropertiesToMainTarget(PBXProject pbxProject, string targetGUID, string pbxProjectPath,
            string pluginPath, bool forceAlwaysEmbedSwiftStandardLibraries)
        {
